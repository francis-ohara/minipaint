...
public class Eraser extends Tool {
    ...
    /**
     * Draws a single point with the default color of the canvas (white) when the mouse is pressed.
     * 
    ...
    /**
     * Draws a final line segment with the default color of the canvas (white) when the mouse is released.
     * 
     * @param g2 The graphics context to draw on.
     * @param cursor The state of the mouse cursor.
     */
    ...
    /**
     * Draws a line segment with the default color of the canvas (white) from the last position to the current position while dragging.
     * 
     * @param g2 The graphics context to draw on.
     * @param cursor The state of the mouse cursor.
     */
